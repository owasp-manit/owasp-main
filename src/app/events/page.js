    ...
    <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 py-10">
      ...
      {!hideTitle && (
        <div className="mb-8 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-sky-400 to-blue-600 inline-block mb-3">
            Past Events
          </h2>
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/80 text-lg leading-relaxed mx-auto max-w-2xl mb-8">
            Join our mailing list to receive notifications about upcoming
