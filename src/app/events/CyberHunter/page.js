...
const CTFInfo = () => {
  const images = ["/images/ch/1.jpg", "/images/ch/cyberhntr.jpg"];
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-slate-900 via-black to-slate-800 text-white px-4">
      ...
      <div className="max-w-5xl mx-auto py-16">
        <h1 className="text-4xl md:text-5xl font-bold text-center mb-6 bg-gradient-to-r from-green-100 to-green-900 text-transparent bg-clip-text">
          Cyberhunter 2024
        </h1>
        {/* Banner */}
        ...
        <div className="bg-slate-800/50 p-8 rounded-2xl shadow-lg mb-12">
          <h2 className="text-2xl font-semibold from-green-100 to-green-900 mb-4">
            Highlights
          </h2>
        ...
        <div className="text-center mt-10">
          <Link
            href="/ComingSoon"
            className="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-green-500 to-green-900 text-white text-lg font-medium rounded-lg shadow-md hover:shadow-sky-500/30 transition duration-300"
            target="_blank"
